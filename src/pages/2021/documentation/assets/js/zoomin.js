      ...
      var a = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          if (A.original) {
            ...
            if (
              ...
              (A.zoomedHd.onerror = function() {
                clearInterval(t),
                console.error('Unable to reach the zoom image target ' + A.zoomedHd.src),
                (A.zoomedHd = null),
                k();
              });
          ...
          var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0,
            o = function() {
              S ||
                ...
                A.zoomedHd &&
                  ((A.zoomedHd.style.transform = ''), A.zoomedHd.removeEventListener('click', e)),
                A.template &&
                  ((A.template.style.transition = 'opacity 150ms'), (A.template.style.opacity = 0)),
        ...
        E = function(e) {
          return (e.metaKey || e.ctrlKey) && O.metaClick
            ? window.open(
              e.target.getAttribute('data-original') || e.target.parentNode.href || e.target.src,
              '_blank',
            )
      ...
      var T = (function(e) {
          try {
            return Array.isArray(e)
              ? e.filter(n)
              : ((o = e),
              NodeList.prototype.isPrototypeOf(o) || HTMLCollection.prototype.isPrototypeOf(o)
